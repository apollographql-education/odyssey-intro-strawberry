...
T = TypeVar("T", bound="SpotifyObjectPaginatedSpotifyObjectArtist")


@_attrs_define
class SpotifyObjectPaginatedSpotifyObjectArtist:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        spotify_object_paginated_spotify_object_artist = cls(
            items=items,
            href=href,
            limit=limit,
            next_=next_,
        ...
        return spotify_object_paginated_spotify_object_artist
