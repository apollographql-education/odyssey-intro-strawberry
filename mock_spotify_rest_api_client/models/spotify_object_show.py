...
T = TypeVar("T", bound="SpotifyObjectShow")


@_attrs_define
class SpotifyObjectShow:
    """
    Attributes:
        available_markets (List[str]):
        copyrights (List['SpotifyObjectCopyright']):
        description (str):
        episodes (SpotifyObjectPaginatedSpotifyObjectEpisodeSimplified):
        explicit (bool):
