...
T = TypeVar("T", bound="SpotifyObjectPaginatedSpotifyObjectTrackSimplified")


@_attrs_define
class SpotifyObjectPaginatedSpotifyObjectTrackSimplified:
    """
    Attributes:
        items (List['SpotifyObjectTrackSimplified']):
        href (str):
        limit (float):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = SpotifyObjectTrackSimplified.from_dict(items_item_data)
        ...
        spotify_object_paginated_spotify_object_track_simplified = cls(
            items=items,
            href=href,
            limit=limit,
            next_=next_,
        ...
        return spotify_object_paginated_spotify_object_track_simplified
