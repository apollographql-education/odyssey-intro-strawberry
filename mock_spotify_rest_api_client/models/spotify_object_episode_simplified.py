...
T = TypeVar("T", bound="SpotifyObjectEpisodeSimplified")


@_attrs_define
class SpotifyObjectEpisodeSimplified:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        spotify_object_episode_simplified = cls(
            audio_preview_url=audio_preview_url,
            description=description,
            duration_ms=duration_ms,
            explicit=explicit,
        ...
        return spotify_object_episode_simplified
